...
var go = module.exports = function (opts) {
  ...
  ncp(p.tgtNodeModules, p.pseudoNodeModules, function (err) {
    ...
    // Link ./bar/node_modules -> ./foo/node_modules/bar/node_modules
    fs.symlinkSync(p.pseudoNodeModules, p.tgtNodeModules); 
    ...
    var dedupe = exec('npm dedupe', { cwd: p.root }, function (err) {
      ...
      Object.keys(pkg.dependencies)
        .forEach(function (k) {
          ...
          if (fs.existsSync(inMain)) return fs.symlinkSync(inMain, inLocal)
